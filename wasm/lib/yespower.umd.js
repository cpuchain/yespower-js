(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.YespowerWASM = {}));
    ...
    var yespower_wasm = (() => {
      var _scriptName = (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('yespower.umd.js', document.baseURI).href));
      return async function(moduleArg = {}) {
        ...
        if (ENVIRONMENT_IS_NODE) {
          ...
          var require$1 = createRequire((typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('yespower.umd.js', document.baseURI).href)));
        }
        ...
        if (ENVIRONMENT_IS_NODE) {
          ...
          if (!(typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('yespower.umd.js', document.baseURI).href)).startsWith("data:")) {
        ...
        function findWasmBinary() {
          ...
          return new URL("yespower_wasm.wasm", (typeof document === 'undefined' && typeof location === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : typeof document === 'undefined' ? location.href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('yespower.umd.js', document.baseURI).href))).href;
        }
        ...
        wasmExports["e"];
        Module["_yespower_wasm"] = wasmExports["f"];
        Module["_malloc"] = wasmExports["g"];
        Module["_free"] = wasmExports["i"];
